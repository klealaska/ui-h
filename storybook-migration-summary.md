...
- `npx storybook@latest automigrate --config-dir libs/shared/ui/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir libs/shared/ui-v2/.storybook --renderer @storybook/angular`

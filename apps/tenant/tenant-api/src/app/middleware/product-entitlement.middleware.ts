...
@Injectable()
export class ProductEntitlementMiddleware implements NestMiddleware {
  use(req: Request, res: Response, next: NextFunction) {
    ...
    req.headers.accept = 'application/x.avidxchange.productentitlements+json;version=1.0.0';
    req.headers['content-type'] =
      'application/x.avidxchange.productentitlements+json;version=1.0.0';
    next();
  }
}

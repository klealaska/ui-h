...
export const environment = {
  production: true,
  isBeta: 'true',
  apiBaseUri: 'https://api-dv01.devavidxcloud.com/v1/avidcaptureapi/',
  bkwsBaseUri: 'https://api-dv01.devavidxcloud.com/v1/buyerkeywordservice/',
  lookupApiBaseUri: 'https://api-dv01.devavidxcloud.com/v1/avidbillproxy/',
  invoiceIngestionApiBaseUri: 'https://api-dv01.devavidxcloud.com/v1/',
  appInsights: {
  ...
  featureFlagUrl: 'https://getfeatureflags-dv-fqbebgc2ccfpdqdn.z01.azurefd.net/api/getfeatureflags',

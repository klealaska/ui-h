...
import { AxMaskedInputComponent } from './ax-masked-input.component';

describe('AxMaskedInputComponent', () => {
  let component: AxMaskedInputComponent;
  let fixture: ComponentFixture<AxMaskedInputComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [AxMaskedInputComponent, MockComponent(AxTextBoxComponent)],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(AxMaskedInputComponent);

...
export const getAllAuth = createSelector(getAuthState, (state: AuthState) => selectAll(state));

export const getAuthEntities = createSelector(getAuthState, (state: AuthState) =>
  selectEntities(state)
);

export const getSelectedId = createSelector(getAuthState, (state: AuthState) => state.selectedId);

export const getSelected = createSelector(getAuthEntities, getSelectedId, (entities, selectedId) =>
  selectedId ? entities[selectedId] : undefined
);

export const getAuthToken = createSelector(getAuthState, (state: AuthState) => state.token);

export const isAuthenticated = createSelector(getAuthToken, token => !!token);

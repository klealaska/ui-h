...
import { ResearchGridComponent } from './research-grid.component';

describe('ResearchGridComponent', () => {
  let component: ResearchGridComponent;
  let fixture: ComponentFixture<ResearchGridComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ResearchGridComponent, MockComponent(ContextMenuComponent)],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(ResearchGridComponent);
